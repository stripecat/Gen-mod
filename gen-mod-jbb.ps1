...
$ingress = "C:\TempProj\Ingress\" # We to get the modules.
...
$catdip = "C:\TempProj\Process\Catdip\" # Store the file where Thimeo WatchCat will find it.

$destinationpath = "C:\TempProj\Ingress\" # The base path, where a new subfolder will be created.
...
foreach ($mod in $dirs) {
    ...
    do {
        ...
        Else {
            logwrite ("... Waiting for WatchCan to find the new file.")
